		...
		public static function defaults() {
			...
			return apply_filters(
				'bstone_theme_defaults', array(
					...
					'enable-title-area-archive'	  => false,
					'enable-title-area-single'	  => false,
					'enable-title-area-page'	  => true,
					'enable-title-area-search'	  => false,
					'enable-title-area-notfound'  => false,
					...
					'bstwidget_top_border'				=> 0,
					'bstwidget_bottom_border'			=> 0,
					'bstwidget_left_border'				=> 0,
					'bstwidget_right_border'			=> 0,
					...
					'batarea_left_padding'			  => 0,
					'batarea_right_padding'			  => 0,
					'safsp_top_padding'			  	  => 0,
					'safsp_bottom_padding'			  => 0,
					...
					'blog-single-meta-margin-top' 	   => 0,
					'blog-single-meta-margin-bottom'   => 0,
